...
class rvForms {
	...
	public function reservation() {
		...
		echo "<script type='text/javascript' src='http://192.168.2.21/wordpress/mbc/wp-includes/js/jquery/jquery.js?ver=1.10.2'></script>";
		...
		echo "<script type='text/javascript' src='http://192.168.2.21/wordpress/mbc/wp-content/plugins/reservations/assets/reservations.js?ver=1.01'></script>";
