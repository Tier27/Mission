	...
	$cutomization_pg_array = array(
		array(
			...
			'fields'=> apply_filters('eventon_settings_general', array(
				...
				array('id'=>'evcal_style_header','type'=>'yesno','name'=>'Disable dynamic styles loading','legend'=>'If making changes to appearance have no effect on front-end enable this and go to myeventon>styles and copy paste auto generated dynamic styles to your theme styles file.'),
